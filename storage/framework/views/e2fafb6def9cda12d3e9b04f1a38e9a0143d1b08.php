                                        ...
                                        <div class="modal-dialog" role="document">
                                          <div class="modal-content">
                                            ...
                                            <div class="btn-group mx-2">
                                                <form action="<?php echo e(url('/acceptCreateRequest/' . $req->id)); ?>" method="post">
                                                ...
                                                <form action="<?php echo e(url('/denyCreateRequest/' . $req->id)); ?>" method="post">
                                                    <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pcp/Desktop/FEUP/LBAW/resources/views/pages/manage_create_requests.blade.php ENDPATH**/ ?>