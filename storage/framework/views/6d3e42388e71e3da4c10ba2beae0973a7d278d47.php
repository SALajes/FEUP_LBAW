    ...
    <div class="row">
       <?php
        ...
        <div id="content" class="col-12 col-lg-9">
            ...
            <input id="student_id" type="hidden" value="<?php echo e($student->id); ?>" readonly>
            <div id="data"></div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cadu/Git/lbaw2013/resources/views/pages/profile.blade.php ENDPATH**/ ?>