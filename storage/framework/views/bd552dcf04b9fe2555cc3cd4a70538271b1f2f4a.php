  ...
  <main class="container marketing mt-5">
    ...
    <section class="row featurette">
      ...
      <picture class="col-md-5 text-center">
        <i
          class="icon-teamwork text-gradient-blue"
    ...
    <section class="row featurette">
      ...
      <picture class="col-md-5 text-center">
        <i
          class="icon-partner text-gradient-blue"
          style="font-size: 10rem;"
        ></i>
      </picture>
    </section>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/simawatt/Documents/FEUP/lbaw2013/resources/views/pages/landing.blade.php ENDPATH**/ ?>