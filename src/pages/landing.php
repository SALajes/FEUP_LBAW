...
?>
<div class="background-gradient-blue">
  <header class="masthead mb-auto pt-3 d-flex pr-5 justify-content-end">
    <div class="inner">
  ...
  <div class="position-relative overflow-hidden p-3 p-md-5 text-center text-white">
